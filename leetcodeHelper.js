...
chrome.webRequest.onBeforeRequest.addListener(
    async function (details) {
        if (details.method === "POST" && details.url.includes("submit") && details.requestBody) {
            // console.log("Processing request:", details.method, details.url);
            try {
            ...
            console.log("Ignored request:", details.method, details.url);
        }
    },
    { urls: ["*://*.leetcode.com/*"] },
    ["requestBody"]
